<svelte:head>
	<title>Offline — Calorie</title>
</svelte:head>

<main class="offline-root">
	<div class="offline-card">
		...
		<p class="offline-sub">Your log is saved. We'll catch up when you reconnect.</p>
		<button type="button" class="offline-retry" onclick={() => window.location.reload()}>
			Try again
		</button>
	</div>
</main>
